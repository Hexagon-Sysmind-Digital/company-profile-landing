                ...
                <div className="max-w-7xl mx-auto w-full px-8">
                    ...
                    >
                        ...
                        <p className="mt-6 text-gray-300 text-lg text-justify">
                            Find clear and concise answers to common questions about our services,
                            processes, and digital solutions. We’re here to provide transparency,
                            clarity, and confidence as you explore how Hexamind can support your
                            business growth.
                        </p>
                    </motion.div>
